...
<main class="index">
	<div class="container p-2">
		<div class="card">
			...
			<div class="card-body">
				<form class="row g-3 needs-validation" id="form" name="form" id="form" method="post" action="formAccion.php" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="form-group mb-3" id="sinopsis">
							<label class="form-label fw-medium">Imagen (JPG/PNG)</label>
							<input type="file" class="form-control validate" id="archivo" name="archivo" accept=".jpg, .png" required>
							<div class="invalid-feedback">
								Ingrese un archivo.
							</div>
						</div>
