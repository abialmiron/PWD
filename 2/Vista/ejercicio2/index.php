        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color:#bebcbc;">
                    ...
                    <a href="ejercicio1/form.php" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color: #201f1f; color: white;">
                    ...
                    <a href="ejercicio2/form.php" class="btn btn-primary btn-primaryMod">Ver</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color:#bebcbc;">
                    ...
                    <a href="ejercicio3/form.php" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color: #201f1f; color: white;">
                    ...
                    <a href="ejercicio4/form.php" class="btn btn-primary btn-primaryMod">Ver</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color:#bebcbc;">
                    ...
                    <a href="ejercicio5/form.php" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color: #201f1f; color: white;">
                    ...
                    <a href="ejercicio6/form.php" class="btn btn-primary btn-primaryMod">Ver</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color:#bebcbc;">
                    ...
                    <a href="ejercicio7/form.php" class="btn btn-primary">Ver</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="background-color: #201f1f; color: white;">
                    ...
                    <a href="ejercicio8/form.php" class="btn btn-primary btn-primaryMod">Ver</a>
                </div>
            </div>
        </div>
        <a class="text-center btn btn-primary mt-4" href="../../index.php">Volver <a>
    </div>
